...
<body>
  ...
  <script>
    ...
    window.deleteSong = function(sid) {
        if(confirm("Permanently delete song?")) {
            // Notă: Momentan API-ul nu are endpoint de ștergere fizică, poți adăuga dacă vrei.
            alert("Delete feature requires backend implementation in upload.php");
        }
    };
